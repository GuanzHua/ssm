...
<meta name="description" content="后台数据管理系统">
<meta name="keywords" content="后台数据管理系统">
									...
									<c:forEach items="${userList}" var="user">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/findById?id=${user.id}" class="btn bg-olive btn-xs">用户详情</a>
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole?id=${user.id}" class="btn bg-olive btn-xs">添加角色</a>
												<a href="${pageContext.request.contextPath}" class="btn bg-olive btn-xs">修改用户</a>
												<a href="${pageContext.request.contextPath}" class="btn bg-olive btn-xs">删除用户</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
